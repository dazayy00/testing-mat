...
describe('SimpsonComponent', () => {
  ...
  it('Should return 16 if f(x)=2x, x0=1 x1=4', () => {
    expect(component.calculateArea('2x', 1, 4, 4, 0.00001)).toBeCloseTo(16.0, 1);
  });

  it('Should return 0.333 if f(x)=x^2, x0=0 x1=1', () => {
    expect(component.calculateArea('x^2', 0, 1, 4, 0.0001)).toBeCloseTo(0.333, 3);
  });

  it('Should return 1.38 in f(x)=1/x, x0=1, x1=4', () => {
    expect(component.calculateArea('1/x', 1, 4, 6, 0.001)).toBeCloseTo(1.386, 3);
  });
});
